...
/**
 * 이 코드의 가장 큰 문제점은 각 class 마다 return 되는 다른 컬렉션의 형식이 다르기기 때문에 두개 class 중 하나가 통합시키지 않는 이상 루프를 2번돌리는 코드를 지우기가 힘들다.
 * 또한 나중에 가게가 들어오고 그 가게도 컬렉션을 쓰게되면 루프문을 3번 쓸수도있다.
